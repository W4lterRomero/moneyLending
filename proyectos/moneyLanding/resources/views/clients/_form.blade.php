        ...
        <div class="grid md:grid-cols-2 gap-3">
            <div>
                ...
                <input type="file" name="photo" accept="image/*" capture="user"
                    class="w-full px-3 py-2 rounded-lg border border-slate-200 focus:border-sky-400 focus:ring focus:ring-sky-100 file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:text-sm file:bg-sky-50 file:text-sky-700 hover:file:bg-sky-100" />
    ...
    <div class="card">
        ...
        <div class="grid md:grid-cols-2 gap-3">
            <div>
                ...
                <select name="status" class="w-full px-3 py-2 rounded-lg border border-slate-200 focus:border-sky-400 focus:ring focus:ring-sky-100">
            ...
            <div class="md:col-span-2">
                ...
                <textarea name="notes" rows="3" class="w-full px-3 py-2 rounded-lg border border-slate-200 focus:border-sky-400 focus:ring focus:ring-sky-100">{{ old('notes', $client->notes ?? '') }}</textarea>
            </div>
        </div>
    </div>
