...
<body class="bg-slate-50 text-slate-800" x-data="{ mobileNav: false }">
    <div class="min-h-screen flex">
        <aside class="w-64 bg-white border-r border-slate-200 hidden md:flex flex-col">
            <div class="p-4 border-b border-slate-100">
                ...
                <div class="text-xs text-slate-500">Gestión de préstamos</div>
            </div>
            ...
            <div class="p-4 border-t border-slate-100">
                <div class="text-xs text-slate-500">Cmd/Ctrl + K para búsqueda global</div>
            </div>
        </aside>
                ...
                <div class="px-4 md:px-6 h-16 flex items-center justify-between">
                    ...
                    <div class="flex items-center gap-3">
                        <button x-data @click="$dispatch('open-search')"
                            class="px-3 py-2 rounded-lg border border-slate-200 text-sm hover:border-sky-300 hover:text-sky-600">
                            Búsqueda (⌘/Ctrl + K)
                        </button>
                        <button @click="$store.theme.toggle()" aria-label="Cambiar tema" class="px-3 py-2 rounded-lg border border-slate-200 text-sm hover:border-sky-300 hover:text-sky-600">
    ...
    <div class="fixed inset-0 z-50 md:hidden" x-show="mobileNav" x-transition.opacity>
        ...
        <aside class="absolute top-0 left-0 w-72 h-full bg-white shadow-xl p-4 space-y-4" x-transition
