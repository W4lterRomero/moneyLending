...
@php
    $icons = [
        ...
        'photo' => '<path stroke-linecap="round" stroke-linejoin="round" d="M5.25 6.75A2.25 2.25 0 0 1 7.5 4.5h9a2.25 2.25 0 0 1 2.25 2.25v9a2.25 2.25 0 0 1-2.25 2.25h-9A2.25 2.25 0 0 1 5.25 15.75v-9Z" /><path stroke-linecap="round" stroke-linejoin="round" d="m5.25 15.75 4.5-4.5a1.5 1.5 0 0 1 2.12 0l4.5 4.5" /><path stroke-linecap="round" stroke-linejoin="round" d="M14.25 9.75h.008v.008h-.008V9.75Z" />',
        'document' => '<path stroke-linecap="round" stroke-linejoin="round" d="M19.5 14.25v-2.625a1.125 1.125 0 0 0-1.125-1.125h-6.75m-1.5 9.75h6.75A1.125 1.125 0 0 0 18.75 18V6a1.125 1.125 0 0 0-1.125-1.125h-6.75A1.125 1.125 0 0 0 9.75 6v12A1.125 1.125 0 0 0 10.875 19.5Z" /><path stroke-linecap="round" stroke-linejoin="round" d="M6.75 7.5h-1.5m1.5 3h-1.5m1.5 3h-1.5m1.5 3h-1.5" />',
        'dots' => '<path stroke-linecap="round" stroke-linejoin="round" d="M6.75 12a.75.75 0 1 1-1.5 0 .75.75 0 0 1 1.5 0Zm6 0a.75.75 0 1 1-1.5 0 .75.75 0 0 1 1.5 0Zm4.5.75a.75.75 0 1 0 0-1.5.75.75 0 0 0 0 1.5Z" />',
    ];
